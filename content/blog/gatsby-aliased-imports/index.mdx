...
<CodeNote href="https://github.com/rutterjt/blog-examples/tree/main/gatsby-aliased-imports" />
...
This is a personal preference, and some developers may disagree with re-exporting everything from the root components folder. But you might find it helpful for organizing your code.
