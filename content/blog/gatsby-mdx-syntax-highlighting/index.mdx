...
<CodeNote href="https://github.com/rutterjt/blog-examples/tree/main/gatsby-mdx-syntax-highlighting" />
...
In order to add syntax highlighting in MDX, we'll need to use a package called [prism-react-renderer](https://github.com/FormidableLabs/prism-react-renderer). This package exports a React component `<Highlight />`, which can render code blocks with the [Prism](https://prismjs.com/) syntax highlighter. Let's install it:
...
There are a lot of ways that you could customize your new syntax-highlighted code blocks. Most of them (like adding line-numbers or diff highlighting) involve getting into the nitty-gritty of `<Highlight />`'s render function. Those really deserve their own post, and I won't get into them here. But we can look at one really easy way of customizing our code blocks: themes.
