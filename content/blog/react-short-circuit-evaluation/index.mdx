...
However, consider the following component, which is code that I've adapted from a [weather app project](https://github.com/rutterjt/weather-app) that I built:
