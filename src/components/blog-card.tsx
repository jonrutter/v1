...
export const BlogCard: React.FC<Props> = ({ item }) => {
  return (
    <article className="shadow-md rounded-xl overflow-hidden bg-white dark:bg-slate-700 flex flex-col md:flex-row lg:flex-col w-full max-w-[325px] md:max-w-full lg:max-w-[325px] mx-auto text-slate-600 dark:text-slate-200 isolate">
      {/* image wrap */}
